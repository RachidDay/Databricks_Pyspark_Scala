...
# MAGIC %md
# MAGIC <iframe  
# MAGIC src="//fast.wistia.net/embed/iframe/1i3n3rb0vy?videoFoam=true"
# MAGIC style="border:1px solid #1cb1c2;"
# MAGIC allowtransparency="true" scrolling="no" class="wistia_embed"
# MAGIC name="wistia_embed" allowfullscreen mozallowfullscreen webkitallowfullscreen
# MAGIC oallowfullscreen msallowfullscreen width="640" height="360" ></iframe>
# MAGIC <div>
# MAGIC <a target="_blank" href="https://fast.wistia.net/embed/iframe/1i3n3rb0vy?seo=false">
# MAGIC   <img alt="Opens in new tab" src="https://files.training.databricks.com/static/images/external-link-icon-16x16.png"/>&nbsp;Watch full-screen.</a>
# MAGIC </div>
...
# MAGIC %md
# MAGIC <iframe  
# MAGIC src="//fast.wistia.net/embed/iframe/w9vj8mjpf7?videoFoam=true"
# MAGIC style="border:1px solid #1cb1c2;"
# MAGIC allowtransparency="true" scrolling="no" class="wistia_embed"
# MAGIC name="wistia_embed" allowfullscreen mozallowfullscreen webkitallowfullscreen
# MAGIC oallowfullscreen msallowfullscreen width="640" height="360" ></iframe>
# MAGIC <div>
# MAGIC <a target="_blank" href="https://fast.wistia.net/embed/iframe/w9vj8mjpf7?seo=false">
# MAGIC   <img alt="Opens in new tab" src="https://files.training.databricks.com/static/images/external-link-icon-16x16.png"/>&nbsp;Watch full-screen.</a>
# MAGIC </div>
...
# MAGIC %sql
# MAGIC SELECT authors[0] AS primaryAuthor 
# MAGIC FROM DatabricksBlog
...
# MAGIC %md
# MAGIC <iframe  
# MAGIC src="//fast.wistia.net/embed/iframe/h8tv263d04?videoFoam=true"
# MAGIC style="border:1px solid #1cb1c2;"
# MAGIC allowtransparency="true" scrolling="no" class="wistia_embed"
# MAGIC name="wistia_embed" allowfullscreen mozallowfullscreen webkitallowfullscreen
# MAGIC oallowfullscreen msallowfullscreen width="640" height="360" ></iframe>
# MAGIC <div>
# MAGIC <a target="_blank" href="https://fast.wistia.net/embed/iframe/h8tv263d04?seo=false">
# MAGIC   <img alt="Opens in new tab" src="https://files.training.databricks.com/static/images/external-link-icon-16x16.png"/>&nbsp;Watch full-screen.</a>
# MAGIC </div>
...
# MAGIC -- ANSWER
# MAGIC
# MAGIC DROP TABLE IF EXISTS ArticlesByMichael;
# MAGIC
...
# MAGIC
# MAGIC resultsDF = spark.sql("select title from ArticlesByMichael order by title")
...
# MAGIC -- ANSWER
# MAGIC
# MAGIC DROP TABLE IF EXISTS UniqueCategories;
# MAGIC
...
# MAGIC 0. The new table contains two columns, `category` and `total`
...
# MAGIC -- ANSWER
# MAGIC
# MAGIC DROP TABLE IF EXISTS TotalArticlesByCategory;
# MAGIC
# MAGIC CREATE OR REPLACE TEMPORARY VIEW TotalArticlesByCategory AS
# MAGIC   SELECT category, 
# MAGIC          count(category) AS total 
# MAGIC   FROM DatabricksBlog
# MAGIC   LATERAL VIEW explode(categories) AS category
...
# MAGIC
# MAGIC SELECT * 
# MAGIC FROM TotalArticlesByCategory 
# MAGIC ORDER BY category

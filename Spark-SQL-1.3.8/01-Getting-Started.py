...
# MAGIC
# MAGIC <iframe  
# MAGIC src="//fast.wistia.net/embed/iframe/706plvqoo8?videoFoam=true"
# MAGIC style="border:1px solid #1cb1c2;"
# MAGIC allowtransparency="true" scrolling="no" class="wistia_embed"
# MAGIC name="wistia_embed" allowfullscreen mozallowfullscreen webkitallowfullscreen
# MAGIC oallowfullscreen msallowfullscreen width="640" height="360" ></iframe>
# MAGIC <div>
# MAGIC <a target="_blank" href="https://fast.wistia.net/embed/iframe/706plvqoo8?seo=false">
...
# MAGIC %sql
# MAGIC SparkSession.sql("SELECT name, age FROM users")
...
# MAGIC ## Next Steps
# MAGIC
# MAGIC Start the next lesson, **Querying Files with SQL**.
# MAGIC 1. Click the **Home** button in the left sidebar
# MAGIC 2. Select your home folder
# MAGIC 3. Select the folder **Course: Spark SQL**
# MAGIC 4. Open the notebook **02-Querying-Files**
# MAGIC
# MAGIC <img src="https://files.training.databricks.com/images/eLearning/open-notebook-spark-sql.png" style="margin-bottom: 5px; border: 1px solid #aaa; border-radius: 10px 10px 10px 10px; box-shadow: 5px 5px 5px #aaa; width: auto; height: auto; max-height: 383px"/>
